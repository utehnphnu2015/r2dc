...
<?php
$this->params['breadcrumbs'][] = ['label' => 'รายการตัวชี้วัดระดับจังหวัด', 'url' => ['index', 'rep_year' => $rep_year]];
    ...
    <div class="box-header with-border">
        <h3 class="box-title" ><i class="glyphicon glyphicon-th-list"></i> 
            ...
            <span style="color: #0000cc">
                <?php
                $topic = TopicProvince::find()->where(['id' => $kpi_id])->asArray()->one();
                echo $kpi_id;
                ?>
            </span>
        </h3>
